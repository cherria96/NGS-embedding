...
from Phylospec.multi_models.DeepPhylo.deepphylo.evaluate import compute_metrics, select_best_epoch
from Phylospec.multi_models.DeepPhylo.deepphylo.model import DeepPhylo_classification
import argparse
