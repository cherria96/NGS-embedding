...
|---|---:|---:|---:|
| RandomForest | 0.3909 | 0.4736 | 0.8869 |
| KNN | 0.3307 | 0.4378 | 0.7698 |
| SVM | 0.3471 | 0.5580 | 0.8141 |
| NNET | 0.4195 | 0.5171 | 0.8543 |
| XGBoost | 0.3195 | 0.3365 | 0.8523 |
| GLMNET | 0.3909 | 0.5489 | 0.8642 |

## Training OOF tuning estimates
| Model | Multilabel MCC | Micro-AUPR | Micro-ROC-AUC |
|---|---:|---:|---:|
| RandomForest | 0.4535 | 0.3619 | 0.7831 |
| KNN | 0.3181 | 0.3005 | 0.7301 |
| SVM | 0.4781 | 0.3662 | 0.7876 |
| NNET | 0.3937 | 0.2849 | 0.7357 |
| XGBoost | 0.3061 | 0.2784 | 0.7505 |
| GLMNET | 0.3580 | 0.2679 | 0.7523 |
...
## Interpretation
SVM is the preferred model under the predeclared joint CV ranking. Test results describe generalization to the held-out groups and do not change that selection.
...
## Reproducibility
Run `python ML/train_family_genomic.py --seed 42 --n-iter 8`. See run_config.json for input hashes, versions and search spaces.
...
Recorded fit warnings: 23; see fit_warnings.csv for candidate and fold details.

Fit warning counts: {('GLMNET', 'ConvergenceWarning'): 17, ('NNET', 'ConvergenceWarning'): 6}. See fit_warnings.csv; iteration-limit fits may not have converged.
