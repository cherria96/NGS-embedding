...
from family_macro_models import SampleAbundanceTaxa, WarningModel
from train_family_macro import metrics, choose_threshold, select_joint

class MacroProtocolTests(unittest.TestCase):
    def test_training_union_strict_boundary(self):
        x=pd.DataFrame({'BAC_F::a':[.1,.10001,1.], 'ARC_F::b':[0,0,10.]})
